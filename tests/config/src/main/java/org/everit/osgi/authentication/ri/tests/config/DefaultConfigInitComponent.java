/**
 * This file is part of org.everit.osgi.authentication.ri.tests.config.
 *
 * org.everit.osgi.authentication.ri.tests.config is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * org.everit.osgi.authentication.ri.tests.config is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU Lesser General Public License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with org.everit.osgi.authentication.ri.tests.config.  If not, see <http://www.gnu.org/licenses/>.
 */
package org.everit.osgi.authentication.ri.tests.config;
...
import org.everit.osgi.authentication.ri.core.AuthenticationServiceConstants;
...
public class DefaultConfigInitComponent {
    ...
    // FIXME remove this service registration
    ...
    public void activate(final BundleContext bundleContext) throws Exception {
        String schemaExpression = "org.everit.osgi.resource";
        createDefaultRequirements(schemaExpression);

        // FIXME remove this property service
        ...
        Dictionary<String, Object> propertyServiceProps = new Hashtable<>();
        propertyServiceProps.put("tempService", true);
        propertyServiceSR = bundleContext
                .registerService(PropertyService.class, propertyService, propertyServiceProps);

        Hashtable<String, Object> authenticationProps = new Hashtable<String, Object>();
        authenticationProps.put(AuthenticationServiceConstants.PROP_PROPERTY_SERVICE_TARGET, "(tempService=true)");
        getOrCreateConfiguration(AuthenticationServiceConstants.COMPONENT_NAME, authenticationProps);
    }
